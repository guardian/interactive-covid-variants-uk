...
function Streamgraph(data, {
  ...
  xDomain, // [xmin, xmax]
  yRange = [marginLeft, width - marginRight], // [left, right]
  yType = d3.scaleLinear, // type of y-scale
  yDomain, // [ymin, ymax]
  xRange = [marginTop, height - marginBottom], // [bottom, top]
  ...
  const yAxis = d3.axisLeft(xScale).ticks(width / 80, xFormat).tickSizeOuter(0);
  ...
  svg.append("g")
    ...
    .join("path")
      ...
      .attr('class',(d,i) => console.log(d,i))
      .attr("d", area)
  ...
  svg.append("g")
      .attr("transform", `translate(${marginLeft + 100},0)`)
      .call(yAxis)
